...
\begin{figure} [!htb]
\centering
\includegraphics[width=9cm, keepaspectratio]{\fpath geant}
\textit{\caption{Risultati di una simulazione eseguita con Geant4. Sono mostrati il numero di particelle (punti), l'energia persa (linea continua). \cite{matthews2005heitler}}
\label{img:geant}
\end{figure} 
